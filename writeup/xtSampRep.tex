...
Another notable difference between our sample and the original is the rate of basic generalizations. In our online studies, we saw much less generalization to the basic level than in the original studies, and our in person experiment. In fact,  our in person experiment was the only experiment to replicate the qualitative pattern of proportions of the original studies: high levels of basic level generalizations in the learner condition. The reason for this difference is unclear, but one possibility is that the online medium created an incentive structure that differed from typical communicative interaction. In particular, participants in the online experiment may have placed greater value on ``getting it exactly right," and may have therefore been less likely to choose the more conservative strategy of generalizing to the basic level uncertainty, relative to participants in the in-person experiments.
