...
strict = F
proper = F # this only affects plots
```
...
xt_data.adults = data.frame(response=c(as.character(teacher_xt_data),as.character(learner_xt_data)))
xt_data.adults$Answer.sample[1:14] = "teacher"
xt_data.adults$Answer.sample[15:28] = "learner"
...
# CHILDREN
n_responses = 24 # N=12/condition, 2 responses/participant
...
xt_data.children$Answer.sample[1:24] = "teacher"
xt_data.children$Answer.sample[25:48] = "learner"
...
t1.f = t1 %>%
       ...
       filter(Answer.click1 == "\"correct\"" & Answer.click2 == "\"correct\"") %>% #correct training items (learning only)
