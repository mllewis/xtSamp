...
Some participants were in another (not analyzed; "noLabel") condition. Below is the total N before any relevant exclusions.
```{r}
total_n = dim(t1)[1] - t1.exclusion.ns[1,"n_noLabelParticipants"] - t1.exclusion.ns[1,"n_repeatWorkers"]
print(paste("Total relevant N: ", total_n))
...
print(paste("Total after preliminary exclusions: ",  dim(t1.f)[1] ))
```
...
print(paste("N `other' participants: ",  dim(others.t1)[1]))
...
Final sample.
```{r}
print(paste("N =",  length(t1.f$Answer.sample)))
...
print(paste("Total after preliminary exclusions:",  dim(t2.f)[1]))
```
...
print(paste("N `other' participants:",  dim(others.t2)[1]))
...
Final sample.
```{r}
print(paste("N =",  length(t2.f$Answer.sample)))
...
print(paste("Total after preliminary exclusions:",  dim(l1.f)[1]))
```
...
print(paste("N `other' participants:", dim(others.l1)[1]))
...
print(paste("Total after preliminary exclusions:", dim(t3.f)[1]))
```
...
print(paste("N `other' participants:", dim(others.t3)[1]))
...
Final sample.
```{r}
print(paste("N = ",  length(t3.f$Answer.sample)))
...
print(paste("Total after preliminary exclusions:",  dim(t4.f)[1]))
```
...
print(paste("N `other' participants:", dim(others.t4)[1]))
...
Final sample.
```{r}
print(paste("N =", length(t4.f$Answer.sample)))
...
#### Testing for moderators with t-tests
##### Person effect
```{r person_effect, eval = F}
...
#### Testing for moderators with logistic regression
