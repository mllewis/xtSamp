...
```{r}
N = 14
N_per_condition = (N/2) #* 2 #2 conditions and 2 trials per participant per condition
# Note: We are aggegating across *trials* not participants -- Though not consistent with the descprition in the original report, this is necessary to assume in order to get the proportions they report.
