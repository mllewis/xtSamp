...
d2 <- read.csv("/Documents/GRADUATE_SCHOOL/Projects/xtSamp/xt_2007b_replication/data/turk_replication_2.csv",sep="\t",header=T)
...
l1 <- read.csv("/Documents/GRADUATE_SCHOOL/Projects/xtSamp/xt_2007b_replication/data/inlab_replication.csv")
