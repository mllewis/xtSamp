...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**[(6) All](#all)** <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;**[(6) Power calculation for Exp. 5 (#power5)** <br/>
...
Method #1: Raw average across all data
```{r}
...
all.es # this is in terms of d

# fixed effects
fixed.effects = rma(effect_size, var_d, data = all.es[1:5,], method = "FE")
forest(fixed.effects, slab=all.es[1:5,"exp"])
power.analysis = pwr.chisq.test(w = fixed.effects$b,df = 1, sig.level = 0.05, power = .95)
power.analysis
print(paste("N for .95 power (fixed effects):", power.analysis$N))

# random effects
random.effects = rma(effect_size , var_d, data = all.es[1:5,])
forest(random.effects, slab=all.es[1:5,"exp"])
power.analysis = pwr.chisq.test(w = random.effects$b,df = 1, sig.level = 0.05, power = .95)
power.analysis
